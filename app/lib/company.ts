...
export const company = {
  ...
  description:
    "北九州を拠点に、建物解体工事・土地開発・リフォームまでをワンストップでご提供。安全・丁寧・スピーディーな施工で、地域の暮らしと未来を支えます。",
  // 許可・登録番号
...
export const greeting = {
  ...
  body: [
    ...
    "北九州を拠点に、大きな工事はもちろん、ご家庭一軒の解体や空き家の片付け、遺品整理まで、一つひとつのご依頼に丁寧に向き合っています。「実家が空き家になって困っている」「何から相談すればいいか分からない」——そんなお悩みにこそ、地域の会社として親身にお応えしたいと考えています。",
